...
module.exports = function (hexo) {
  hexo.on('generateBefore', function () {
    ...
    if (result.footer.powered) result.footer.powered = __('footer.powered', '<a href="https://hexo.io" target="=_blank" rel="external">Hexo</a>')
    if (result.footer.theme) result.footer.theme = __('footer.theme') + ' - <a href="https://github.com/ike-c/hexo-theme-inside" target="=_blank" rel="external">Inside</a>'
