...
describe('md', function () {
  const md = require('../../../lib/renderer/md');
  ...
  it('render img', function () {
    ...
    expect(render({ text: '![img](img.png "|block")' }))
      .toBe('<p><img src="img.png?" class="img" alt="img"></p>');
  ...
  it('render heading', function () {
    expect(render({ text: '# h1' }))
      .toBe('<h1 id="h1">h1<a href="#h1" title="h1"></a></h1>');
  });
  it('render list', function () {
    ...
    expect(render({ text: '1. 1' }))
      .toBe('<ol><li>1</li></ol>');
    expect(render({ text: '- [ ] 1' }))
      .toBe('<ul><li><input type="checkbox" disabled><i></i>1</li></ul>');
    expect(render({ text: '- [x] 1' }))
      .toBe('<ul><li><input type="checkbox" disabled checked><i></i>1</li></ul>');
  });
